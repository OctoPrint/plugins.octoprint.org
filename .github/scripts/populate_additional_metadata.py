...
github_query_executor = concurrent.futures.ThreadPoolExecutor(max_workers=5)
...
def github_data(user, repo, out=print):
    ...
    repository_values = future.result()
...
if __name__ == "__main__":
    ...
    batcher = threading.Thread(target=github_batcher)
    batcher.daemon = True
    batcher.start()
